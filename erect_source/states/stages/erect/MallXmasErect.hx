...
class MallXmasErect extends BaseStage
{
	...
	override function create()
	{
		...
		#if !DISABLE_EGGNOG_ERECT_CUTSCENE
		if(songName == "eggnog" && (Difficulty.getString() == "Nightmare" || Difficulty.getString() == "Erect")){
			erectSanta = new FlxAtlasSprite(-840 +380, 150 +347,"assets/week_assets/week5/images/christmas/santa_speaks_assets");
			erectParents = new FlxAtlasSprite(100 -620, 100 + 401,"assets/week_assets/week5/images/christmas/parents_shoot_assets");
