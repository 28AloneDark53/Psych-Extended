...
{
  public static function getEffectTypeId(v:WiggleEffectTypeClone):Int
  {
    return WiggleEffectTypeClone.getConstructors().indexOf(Std.string(v));
  }

  public var effectType(default, set):WiggleEffectTypeClone = DREAMY;

  function set_effectType(v:WiggleEffectTypeClone):WiggleEffectTypeClone
  {
  ...
  public function new(speed:Float, freq:Float, amplitude:Float, ?effect:WiggleEffectTypeClone = DREAMY):Void
  {
